import { ActionRowBuilder, APIEmbed, APIEmbedField, ApplicationCommandOptionType, ComponentType, StringSelectMenuBuilder } from "discord.js";
        ...
        if (command) {            
            ...
            for (const [k, v] of client.commands) {
                ...
                if (!k.includes("/")) {
                    ...
                    if (!categoryList.includes(v.category) && !helpConfig.ignore.includes(v.category)) {
